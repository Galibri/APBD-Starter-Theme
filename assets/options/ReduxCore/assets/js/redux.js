                ...
                setTimeout(
                    function() {
                        ...
                        if ( $( '#redux-header' ).length > 0 ) {
                            $( '#redux-header' ).append( '<div class="rrrAds"></div>' );
                            el = $( '#redux-header' );
                        } else {
                            $( '#customize-theme-controls ul' ).first().prepend( '<li id="redux_rAds" class="accordion-section rAdsContainer" style="position: relative;"><div class="rrrAds"></div></li>' );
                            el = $( '#redux_rAds' );
                        }
