...
if ( ! class_exists( 'CMB2_Bootstrap_224', false ) ) {
	...
	class CMB2_Bootstrap_224 {
		...
		public function l10ni18n() {
			...
			$loaded = load_plugin_textdomain( 'multi-blog', false, '/languages/' );

			if ( ! $loaded ) {
				$loaded = load_muplugin_textdomain( 'multi-blog', '/languages/' );
			}

			if ( ! $loaded ) {
				$loaded = load_theme_textdomain( 'multi-blog', get_stylesheet_directory() . '/languages/' );
			}
